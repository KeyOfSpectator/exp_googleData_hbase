...
import thread.OptThread_split2Table_DynamicNum;
 ...
 *
 */
public class Exp_thoughput_split2table_DynamicThreads_50WLine {
...
//		store
		...
		for (int i = 0; i < threadCount; i++) {
			 ...
			 * , String tableName)
			 */
			Thread t = new OptThread_split2Table_DynamicNum(i,threadCount , csvFolderPath, site_PathStr, tableName );
			allthreads.add(t);
