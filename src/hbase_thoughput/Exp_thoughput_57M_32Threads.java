...
public class Exp_thoughput_57M_32Threads {
	...
	public static void main(String[] args) {
		...
		final int opcount = 15625;
		
//		createtable
		Configuration conf = HBaseConfiguration.create();
		HTableDescriptor htd = new HTableDescriptor(tableName);
		try {
			Hbase_createTable_googleData_util.hbase_createTable(site_PathStr, conf, htd, tableName, 0, 500000, 32);
...
//		store
		...
		for (int i = 0; i < threadCount; i++) {
			/*
			 * OptThread(int threadId , String FolderPath , String site_PathStr
			 * , String tableName)
			 */
			Thread t = new OptThread(i, csvFolderPath, site_PathStr, tableName);
			allthreads.add(t);
