...
public class OptThread_testReadFile extends Thread{
	...
	public OptThread_testReadFile(int threadId , int threadCount , String FolderPath){
...
//							+ " [Line] HBase write line : " + i);
				...
				System.out.println("[Thread Info]"
						+ " threadId = " + this.threadId
						+ " [Time] HBase write time : " + total_readFile_time);
				System.out.println("[Thread Info]"
						+ " threadId = " + this.threadId
